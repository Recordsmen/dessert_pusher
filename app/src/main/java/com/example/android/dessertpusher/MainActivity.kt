...
const val DESSERTS_KEY = "DESSERTS_SOLDS"
...
class MainActivity : AppCompatActivity(), LifecycleObserver {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(savedInstanceState != null){
            ...
            dessertsSold = savedInstanceState.getInt(DESSERTS_KEY)
            dessertTimer.secondsCount = savedInstanceState.getInt(TIME_KEY)
        }
    ...
    override fun onSaveInstanceState(outState: Bundle) {
        ...
        outState.putInt(TIME_KEY,dessertTimer.secondsCount)
    }
}
